! function e(t, n, r) {
    ...
    13: [function(e, t, n) {
        ...
        function o(e) {
            var t = r(),
                n = 0;
            i(e) && (e && (n = u(e)), t.unbind("scroll"), t.animate({
                scrollTop: n
            }, 800, "swing", function() {
                t.scroll(f)
            }), l(null, e))
        ...
        function u(e) {
            ...
            u = o.position().top;
            for (var l = 10, c = 0; c < l && (!i.is(n) && !i.is(i.offsetParent())); c++) o = i, u += o.position().top, i = o.offsetParent();
            return Math.floor(u)
        }

        function l(e, t) {
            if (e || t || (e = w.first()), t && (e = w.length > 1 ? w.filter(function() {
                    var e = c(T(this));
                    return e == t
                }).first() : w.first()), !e.is(C)) {
        ...
        function f() {
            ...
            }), a || t || (a = w.first()), t && n - t == o && (a = w.last()), l(a)
        }
        ...
        function p(e, t) {
            ...
            if (!S || u) return void(location.href = e);
            ...
            var l = T.Deferred(function(e) {
                T.ajax({
                    ...
                    success: function(n, i, s) {
                        ...
                        t && history.pushState({
                            path: u
                        }, null, u), c = T(n), l = c.find("[data-element=head]"), f = c.find(".book"), document.title = l.find("title").text();
                        var h = T("head");
        ...
        function x() {
            ...
            }, T(document).on("click", ".navigation-prev", v), T(document).on("click", ".navigation-next", v), T(document).on("click", ".summary [data-path] a", v), T(document).on("click", ".page-inner a", v), T(window).resize(h), d(!1)
        }
        var w, C, T = e("jquery"),
            k = e("url"),
            j = e("./loading"),
            E = e("./platform"),
            N = window.gitbook,
            S = "undefined" != typeof history.pushState,
            A = location.href;
        t.exports = {
            init: x,
            goNext: y,
